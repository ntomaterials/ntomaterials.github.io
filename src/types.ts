 ...
 * Конкретные значения настраиваются в src/scoring/constants.ts
 * (POSITIVE_MAX, POSITIVE, NEUTRAL, NEGATIVE) и могут быть как целыми,
 * так и дробными — тип намеренно не сужен до литералов.
 */
...
export interface AnswerOption {
  /** Балл варианта — значение одной из констант POSITIVE_MAX/POSITIVE/NEUTRAL/NEGATIVE. */
